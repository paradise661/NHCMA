                            ...
                            <div class="img-wide">
                                ...
                                <div class="container">
                                    ...
                                    <div class="btn-group btn-group-lg d-none d-md-block d-lg-block">
                                        <a class="btn btn-primary" href="{{ route('mediacoverages') }}">Media Coverages</a>
                                        <a class="btn btn-primary" href="{{ route('activities') }}">Activities</a>
                                        <a class="btn btn-primary" href="{{ route('blogs') }}">Blogs</a>
                                        <a class="btn btn-primary" href="{{ route('page.show', 'become-a-member') }}">Become
                                            a Member</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    @foreach ($upcoming_events as $event)
                        <div class="col-md-6 col-sm-12  mb-4">
                            ...
                            <div class="img-portrait">
                                ...
                                <p class="bg-white text-black p-2">{{ date('M j, Y', strtotime($event->date)) ?? '' }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="col-md-4 col-sm-12 d-grid align-self-stretch">
                            <div class="card-blog">
                                ...
                                <div class="card-blog-text">
                                    ...
                                    <a class="text-secondary" href="{{ route('blogs.show', $blog->slug) }}">Read More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
