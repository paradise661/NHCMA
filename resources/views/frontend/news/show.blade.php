...
@section('seo')
    <title>{{ $newsdetails->seo_title ?? 'Nepal Health Care Manager Association' }}</title>
    <meta name="keywords" content="{{ $newsdetails->meta_keywords ?? 'Nepal Health Care Manager Association' }}">
    <meta name="description" content="{{ $newsdetails->meta_description ?? 'Nepal Health Care Manager Association' }}">
@endsection
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
                        ...
                        <div class="media-wrapper pe-5 w-100 ">
                            <img class="br-12" src="{{ asset('admin/images/' . $newsdetails->image) }}" alt="">
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="sidebar mb-5">
                            ...
                            <ul class="navbar-nav">
                                <li class="title text-white bg-primary br-4 ps-4">More News</li>
                                @foreach ($morenews as $news)
                                    <a class="text-decoration-none" href="{{ route('news.show', $news->slug) }}">
