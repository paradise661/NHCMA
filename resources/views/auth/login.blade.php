...
<head>
    ...
    <title>Nepal Health Care Manager's Association</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a class="app-brand-link gap-2" href="{{ route('login') }}">
                                ...
                                <img src="{{ $settings['site_main_logo'] ? asset('admin/images/setting/' . $settings['site_main_logo']) : asset('frontend/assets/images/logo1.png') }}"
                                    alt="logo" width="250">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to NHCMA! </h4>
