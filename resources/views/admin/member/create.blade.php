            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.members.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="basic-default-fullname">Membership ID</label>
                            <input class="form-control @error('membership_id') is-invalid @enderror" id=""
                                type="text" name="membership_id" value="{{ old('membership_id') }}" placeholder="">
                            @error('membership_id')
                                <div class="invalid-feedback" style="display: block;">
                                    {{ $message }}
                                </div>
