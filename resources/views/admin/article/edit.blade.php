        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('admin.articles.index') }}"><i
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('title') is-invalid @enderror" id=""
                                    type="text" value="{{ old('title', $article->title) }}" name="title"
                                    placeholder="">
                                @error('title')
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control datepicker @error('date') is-invalid @enderror"
                                        id="" type="text" value="{{ old('date', $article->date) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('order') is-invalid @enderror" id=""
                                        type="number" value="{{ old('order', $article->order) }}" name="order"
                                        placeholder="" min="1">
                                    @error('order')
                                        <div class="invalid-feedback" style="display: block;">
                                            <i>*{{ $message }}</i>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror ckeditor" id="" name="description"
                                    rows="8" placeholder="">{{ old('description', $article->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description"
                                    rows="4" placeholder="">{{ old('short_description', $article->short_description) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                @if ($article->image)
                                    <img class="mt-2 old-image" src="{{ asset('admin/images/' . $article->image) }}"
                                        width="100">
                                @endif
                                @error('image')
                                    <div class="invalid-feedback" style="display: block;">
                            ...
                            <div class="card card-body seo my-3 shadow br-8 p-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('seo_title') is-invalid @enderror" id=""
                                        type="text" name="seo_title" value="{{ old('seo_title', $article->seo_title) }}"
                                        placeholder="">
                                    @error('seo_title')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="" name="meta_description"
                                        rows="8">{{ old('meta_description', $article->meta_description) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('seo_schema') is-invalid @enderror" id="" name="seo_schema"
                                        rows="8">{{ old('seo_schema', $article->seo_schema) }}</textarea>
                                    @error('seo_schema')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('meta_keywords') is-invalid @enderror"
                                        ...
                                        value="{{ old('meta_keywords', $article->meta_keywords) }}" placeholder="">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
