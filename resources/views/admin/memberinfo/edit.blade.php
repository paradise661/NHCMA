    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit MemberInfo "{{ $memberinfo->title }}"</h5>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.memberinfos.update', $memberinfo->id) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('title') is-invalid @enderror" id="" type="text"
                            name="title" value="{{ old('title', $memberinfo->title) }}" placeholder="">
                        @error('title')
                    ...
                    <div class="mb-3 row">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" id="" name="type">
                                <option value="General" {{ $memberinfo->type == 'General' ? 'selected' : '' }}>General
                                </option>
                                <option value="Lifetime" {{ $memberinfo->type == 'Lifetime' ? 'selected' : '' }}>Lifetime
                                </option>
                                <option value="Executive" {{ $memberinfo->type == 'Executive' ? 'selected' : '' }}>Executive
                                </option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback" style="display: block;">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control @error('order') is-invalid @enderror" id="" type="number"
                                value="{{ old('order', $memberinfo->order) }}" name="order" placeholder="" min="1">
                            @error('order')
                                <div class="invalid-feedback" style="display: block;">
                                    <i>*{{ $message }}</i>
                                </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control ckeditor @error('description') is-invalid @enderror" id="" name="description"
                            rows="8" placeholder="">{{ old('description', $memberinfo->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback" style="display: block;">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($memberinfo->image)
                            <img class="mt-2 old-image" src="{{ asset('admin/images/' . $memberinfo->image) }}"
                                width="100">
                        @endif
                        @error('image')
                            <div class="invalid-feedback" style="display: block;">
