    ...
    <div class="col-xl">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create EventRegister</h5>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.eventsregister.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                            <div class="mb-3">
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control @error('location') is-invalid @enderror" id=""
                                        type="text" name="location" value="{{ old('location') }}" placeholder="">
                                    @error('location')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
